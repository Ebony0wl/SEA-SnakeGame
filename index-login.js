...
window.snapKitInit = function () {
  ...
  snap.loginkit.mountButton(loginButtonIconId, {
    clientId: '5b890e72-583d-482e-9f94-e8303db086bb', /*YOU CHANGE: Must be changed to the development client ID on snapckit*/
    redirectURI: 'https://snapwhat.glitch.me/', /*YOU CHANGE: Must be changed to your glitch project's url AND added as the redirect URI on snapkit */
    scopeList: [
      'user.display_name',
      'user.bitmoji.avatar',
    ],
